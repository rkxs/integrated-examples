...
### 服务端综合应用配置示例
#### &emsp;v2ray或Xray为主、caddy2为辅的综合应用。
...
#### &emsp;平衡及兼顾各自优势的综合应用。
1. [v2ray(complete+h2c)+naiveproxy+trojan+nginx\haproxy](https://github.com/lxhao61/integrated-examples/tree/master/v2ray(complete%2Bh2c)%2Bnaiveproxy%2Btrojan%2Bnginx%5Chaproxy) （用nginx或haproxy对各应用SNI分流，平衡及兼顾。）  
---
